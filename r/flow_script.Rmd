...
Create a flow diagram with clear arrows and boxes from the following components. Include the step-by-step copy used in the diagram as separate text below the final diagram in clear steps. Set 'Comfortaa' as the default font in the workspace for all text copy, flow diagams, and generated images. For the summary, use a voice and tone of an informative product designer that is highlighting the steps and pathways of the flow diagram in an practical and concise manner. Be succinct, 10-15 words per bullet point. Ignore specific variable related instructions e.g. set variable, extract numbers, etc. Consolidate and repetitive and high level intructions. 
