...
Extracting LinkedIn profile data using a QR code scanner (Telegram, Whatsapp), updating a mailing list database (Clickup, Airtable, Google Sheets), auto draft a personalised email/doc with your own copy/CTA, and save to the cloud (Clickup, Notion, Google Drive), then initiate an auto email campaign from the client database.   
