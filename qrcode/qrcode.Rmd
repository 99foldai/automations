---
params:
  title: "LinkedIn profile audit (leads database)"         
...
Extracting LinkedIn profile data using a QR code scanner (Telegram, Whatsapp), update a mailing list database (Notion, Clickup, Airtable), auto draft a personalised email/doc with your own copy/CTA, and save to the cloud (Google Drive), then initiate an auto email campaign from the client database.     
